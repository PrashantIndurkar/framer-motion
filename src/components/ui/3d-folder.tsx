    ...
    <>
      <div
        className={cn(
          ...
          "p-0 rounded-3xl cursor-pointer",
      ...
      >
        <div className="relative flex items-center justify-center" style={{ height: "220px", width: "280px" }}>
          {/* Folder back layer */}
          <div
            className="absolute w-[260px] h-[180px] bg-[#f0f0f0] rounded-[24px] shadow-sm"
            style={{
              top: "30px",
          ...
          {/* Folder tab - Left aligned as per design */}
          <div
            className="absolute w-24 h-10 bg-[#f0f0f0] rounded-t-[18px]"
            style={{
              top: "12px",
              left: "10px",
              transformOrigin: "bottom center",
              transform: isHovered ? "rotateX(-15deg) translateY(-2px)" : "rotateX(0deg)",
              transition: "transform 600ms cubic-bezier(0.2, 0.8, 0.2, 1)",
              zIndex: 10,
            }}
          />

          {/* Project cards peeking out */}
          <div
            className="absolute"
            style={{
              top: "40%",
          ...
          {/* Folder front layer */}
          <div
            className="absolute w-[260px] h-[180px] bg-[#f0f0f0] rounded-[24px] shadow-[0_15px_35px_rgba(0,0,0,0.08)] flex items-center justify-center overflow-hidden"
            style={{
              top: "35px",
              transformOrigin: "bottom center",
              transform: isHovered ? "rotateX(20deg) translateY(12px) translateZ(10px)" : "rotateX(0deg)",
              transition: "transform 600ms cubic-bezier(0.2, 0.8, 0.2, 1)",
              zIndex: 30,
            }}
          >
            {/* Signature "W" logo */}
            <span className="text-[100px] font-serif italic font-bold text-black/[0.04] select-none pointer-events-none tracking-tight">
              W
            </span>
            
            {/* Subtle inner shadow/border for front panel */}
          ...
          {/* Folder shine effect */}
          <div
            className="absolute w-[260px] h-[180px] rounded-[24px] overflow-hidden pointer-events-none"
            style={{
              top: "35px",
...
export const ProjectCard = forwardRef<HTMLDivElement, ProjectCardProps>(
  ({ image, title, delay, isVisible, index, onClick, isSelected }, ref) => {
    ...
    const translations = [-120, 0, 120]

    return (
      <div
        ref={ref}
        className={cn(
          "absolute w-[140px] h-[100px] rounded-[14px] overflow-hidden shadow-[0_8px_25px_rgba(0,0,0,0.15)]",
          "bg-white border-2 border-white",
          "cursor-pointer hover:ring-2 hover:ring-black/5 transition-all duration-300",
          isSelected && "opacity-0",
        )}
        style={{
          transform: isVisible
            ? `translateY(-140px) translateX(${translations[index]}px) rotate(${rotations[index]}deg) scale(1.1)`
            : `translateY(-35px) translateX(${translations[index] * 0.1}px) rotate(${rotations[index] * 0.5}deg) scale(0.95)`,
          opacity: isSelected ? 0 : 1,
          transition: isVisible 
            ? `all 800ms cubic-bezier(0.2, 0.8, 0.2, 1) ${delay}ms`
            : "all 600ms cubic-bezier(0.2, 0.8, 0.2, 1)",
          zIndex: isVisible ? 40 : 10 - index,
          left: "-70px",
          top: "-50px",
        }}
        onClick={(e) => {
